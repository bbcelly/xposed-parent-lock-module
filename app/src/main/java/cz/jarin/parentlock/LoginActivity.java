...
////			getSharedPreferences("xxx", MODE
			SharedPreferences sharedPreferences = getPreferences(MODE_PRIVATE);
			SharedPreferences.Editor editor = sharedPreferences.edit();
			editor.putString("xxx", "test");
			editor.apply();

			SharedPreferences sharedPreferences2 = getSharedPreferences("asd", MODE_PRIVATE);
			SharedPreferences.Editor editor2 = sharedPreferences2.edit();
			editor2.putString("xxx", "test");
			editor2.apply();

			SharedPreferences sharedPreferences3 = getSharedPreferences("asdr", MODE_WORLD_READABLE);
			SharedPreferences.Editor editor3 = sharedPreferences3.edit();
			editor3.putString("xxx", "test");
			editor3.apply();
